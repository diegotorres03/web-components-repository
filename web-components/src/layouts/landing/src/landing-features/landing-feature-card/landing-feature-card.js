...
import componentHtml from './landing-feature-card.html';
import componentStyle from './landing-feature-card.css';

export default class LandingFeatureCard extends HTMLElement {
