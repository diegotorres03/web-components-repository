...
import componentHtml from './landing-testimonials.html';
import componentStyle from './landing-testimonials.css';

export default class LandingTestimonialsComponent extends HTMLElement {
